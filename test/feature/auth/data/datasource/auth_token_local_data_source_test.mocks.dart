...
// in the_24_hour/test/feature/auth/data/datasource/auth_token_local_data_source_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBox extends _i1.Mock implements _i2.Box<_i7.AuthTokenModel> {
  @override
  Iterable<_i7.AuthTokenModel> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i7.AuthTokenModel>[],
        returnValueForMissingStub: <_i7.AuthTokenModel>[],
      ) as Iterable<_i7.AuthTokenModel>);
  @override
  ...
  @override
  Iterable<_i7.AuthTokenModel> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.AuthTokenModel? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
        returnValueForMissingStub: null,
      ) as _i7.AuthTokenModel?);
  @override
  Map<dynamic, _i7.AuthTokenModel> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i7.AuthTokenModel>{},
        returnValueForMissingStub: <dynamic, _i7.AuthTokenModel>{},
      ) as Map<dynamic, _i7.AuthTokenModel>);
  @override
  ...
  @override
  _i3.Future<void> putAll(Map<dynamic, _i7.AuthTokenModel>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i3.Future<int> add(_i7.AuthTokenModel? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<_i7.AuthTokenModel>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
